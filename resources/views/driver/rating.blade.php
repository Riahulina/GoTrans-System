<x-app-layout>
    ...
    <div class="min-h-screen bg-[#0b1220] flex items-center justify-center px-4">
        ...
        <div
            class="w-full max-w-sm h-[90vh] bg-[#0b1220] text-white rounded-3xl shadow-2xl flex flex-col border border-white/10 overflow-hidden">
            ...
            <div class="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <div class="relative flex items-center justify-center mb-4">
                    ...
                    <div class="absolute w-40 h-40 bg-yellow-300 opacity-10 rounded-full blur-2xl animate-pulse"></div>
            ...
            <div class="px-4 pb-3 flex-1 overflow-y-auto space-y-3">
                ...
                @forelse($ratings as $rating)
                    <div class="bg-white/10 rounded-xl p-3 hover:bg-white/15 transition">
            ...
            <div class="p-4 border-t border-white/10">
                ...
                <a href="{{ route('driver.review.detail', $ratings->first()->id ?? 1) }}"
                    class="block w-full py-3 rounded-xl bg-white/10 hover:bg-white/20 text-center text-sm font-medium transition active:scale-95">
