...
<div class="main-content" id="main">
   ...
   <div class="navbar d-flex justify-content-between">
    ...
    <h5 class="mb-0">Manajemen Pesanan</h5>
    <button class="btn btn-primary"><i class="bi bi-plus"></i> Tambah Pesanan</button>
  </div>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>Jane Smith</td>
            <td>2023-10-10</td>
            <td><span class="badge bg-success">Menunggu</span></td>
            <td>
