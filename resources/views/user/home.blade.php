        ...
        <div class="container-fluid px-0">
            <div class="row align-items-center min-vh-100 px-5">
                ...
                <div class="col-md-6 text-center fade-up">
                    <img src="https://cdn-icons-png.flaticon.com/512/1995/1995470.png" class="hero-img" alt="GoTrans">
                </div>
    ...
    <section id="layanan" class="section-white">
        <div class="container">
            ...
            <div class="row g-4 text-center">
                @foreach ([['Motor', 'Cepat & hemat', '🏍️'], ['Mobil', 'Nyaman & aman', '🚗'], ['Bajai', 'Fleksibel', '🛺'], ['Bus', 'Kapasitas besar', '🚌']] as $item)
                    <div class="col-md-3 fade-up">
                        <div class="service-card">
                            <div class="service-icon">{{ $item[2] }}</div>
                            <h5 class="mt-3">{{ $item[0] }}</h5>
                            <p>{{ $item[1] }}</p>
                            <a href="{{ route('user.layanan') }}" class="btn btn-dark btn-sm">Pesan</a>
                        </div>
                    </div>
                @endforeach
            </div>
